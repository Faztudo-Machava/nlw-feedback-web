    ...
    return (
        <>
            ...
            <div className='flex flex-col py-10 items-center w-[304px]'>
                ...
                <button
                    type='button'
                    className='py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors'
